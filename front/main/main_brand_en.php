...
<div class="main-brand-wrap tab-wrapper">
	<div class="tab-button-wrap">
		<a href="#tab01" class="active noscroll"><img src="/img/main/main03_icon01.png" alt="">Bakery & desserts</a>
		<a href="#tab02" class="noscroll"><img src="/img/main/main03_icon02.png" alt="">Dining</a>
		<a href="#tab03" class="noscroll"><img src="/img/main/main03_icon03.png" alt="">Coffee & other beverages</a>
		<a href="#tab04" class="noscroll"><img src="/img/main/main03_icon04.png" alt="">Distribution & services</a>
	</div>
					 	...
					 	<li class="swiper-slide">
					 		<div class="brand-btn">
								...
								<div class="back">
									...
									<strong><?php echo $row2['cate_name_en']?></strong>
									<?php echo $row2['cate_dis_en']?></a>
								</div>
					 		</div>
						</li>
						<?php 
