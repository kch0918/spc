...
<div class="main-brand-wrap tab-wrapper">
	<div class="tab-button-wrap">
		<a href="#tab01" class="active noscroll"><img src="/img/main/main03_icon01.png" alt="">面包店/甜点</a>
		<a href="#tab02" class="noscroll"><img src="/img/main/main03_icon02.png" alt="">餐饮</a>
		<a href="#tab03" class="noscroll"><img src="/img/main/main03_icon03.png" alt="">咖啡/饮料</a>
		<a href="#tab04" class="noscroll"><img src="/img/main/main03_icon04.png" alt="">流通/服务</a>
	</div>
					 	...
					 	<li class="swiper-slide">
					 		<div class="brand-btn">
								...
								<div class="back">
									...
									<strong><?php echo $row2['cate_name_cn']?></strong>
									<?php echo $row2['cate_dis_cn']?></a>
								</div>
					 		</div>
						</li>
						<?php 
