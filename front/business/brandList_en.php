...
{
	location.href="/business/brand-detail/?idx="+idx + "&lang=en";
}
</script>
			...
			<ul class="lnb-ul">
                ...
                <li>
                	...
                	<ul class="lnb-dep">
                		...
                		?>
                			<li><a href="javascript:goBrand_Detail(<?php echo $row2['idx']?>);"><?php echo $row2['cate_name_en']?></a></li>
                		<?php    
                		}
                		?>
                	</ul>
						...
						for($n = 0; $n < sql_count($result2); $n++){
        					...
        					<a href="javascript:goBrand_Detail(<?php echo $row2['idx']?>)">
    							...
    							<div class="back">
									<div class="table">
										<div class="ft-16">
											<strong class="ft-20"><?php echo $row2['cate_name_en']?></strong>
											<?php echo $row2['cate_dis_en']?>
