...
<div class="subs-detail">
	...
	<div class="sdetail-left">
		<p><?php echo $row['cate_brand_kr']?></p>
		<a href="/subsidiary-list/" class="back-btn">뒤로가기</a>
		<a class="cls-btn pc-ver">뒤로가기</a>
	</div>
			...
			<div>
				<div class="sdetail-grid">
					<div class="sdetail-txt">
						<p class="img-ani bottom-top tran01 ft-36"><?php echo $row['cate_dis']?></p>
						<h2 class="img-ani bottom-top tran02"><?php echo $row['cate_name']?></h2>
	...
	<div class="sdetail-bot" animation-value="0">
		<div class="sdetail-grid">	
			<div class="sdetail-left mo-ver">
				<a class="cls-btn">뒤로가기</a>
			</div>
			<div class="sdetail-dot img-ani"></div>
			<div class="sde-infowr">
				<div class="sde-maxw img-ani bottom-top">
					<a href="<?php echo $row['home_url']?>" class="home-go"><span class="home-iwr"><img src="/img/subsidiary/home-i.png" alt="홈페이지바로가기"/></span>홈페이지</a>
					<h2 class="ft-41"><span class="ft-18"><?php echo $row['cate_brand_kr']?></span><?php echo $row['cate_name']?></h2>
				</div>
				<div class="sde-img round-box img-ani bottom-top"><img src="/aDmin/file/<?php echo $row['cont_img']?>" alt="<?php echo $row['cate_name']?>"/></div>
				<div class="sde-maxw">
