...
{
	location.href="/business/subsidiary-detail/?idx="+idx;
}
</script>
	...
	<div class="lnb brand-cate">
		<div class="cate-ulwr">
			...
			<ul class="lnb-ul">
                ...
                ?>
                <li>
                	<a href="/"><?php echo $row['cate_brand_kr']?></a>
                	<ul class="lnb-dep">
                		<?php 
                		...
                		?>
                			<li><a href="javascript:goSub_Detail(<?php echo $row2['idx']?>)"><?php echo $row2['cate_name']?></a></li>
                		<?php    
                		}
                		?>
                	</ul>
	...
	<div class="blist-wr cardtype-list">
    	<?php 
    		...
    		<div class="blist-box">
				...
				?>        		
    			<p class="blist-bgt"><?php echo $row['cate_brand_kr']?></p>
					...
					for($n2 = 0; $n2 < sql_count($result2); $n2++){
					    ...
					    ?>
        					<li class="slist" onclick="goSub_Detail(<?php echo $row3['parentidx']?>)">
        						...
        						<div class="cont">
        							<strong class="ft-24"><?php echo $row3['cate_name']?></strong>
        							<p class="desc ft-16"><?php echo $row3['cate_dis']?></p>
        							<div class="etc">
        								<a>MORE VIEW</a>
        							</div>
        						</div>
