...
<div class="brand-detail brand-detail-<?php echo $row['idx']?>">
	<div class="bdetail-top">
		...
		<div class="bdtop-txt">
			<div class="img-ani bottom-top">
				<p class="bd-cata"><?php echo $row['cate_brand_en']?></p>
				<h2><?php echo $row['cate_name_en']?></h2>
				<p class="bd-stit ft-25"><?php echo $row['cate_dis_en']?></p>
			</div>
		</div>
	</div>
	<div class="bdetail-bot">
		...
		<div class="bdet-txt">
			...
			<div class="bdet-tit ft-34 img-ani bottom-top"><?php echo $row['title_en']?></div>
