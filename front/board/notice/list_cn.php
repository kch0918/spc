...
$query2 = "select *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 from SPC_NOTICE where lang = 'cn' and expo_yn='Y'";
// print_r($_POST);
...
<div class="notice-sec">
	<div class="contri-list cardtype-list">
      <form id="fncForm" name="fncForm" method="post" action="/share/spc-foundation/notice/?lang=zh-hans">
