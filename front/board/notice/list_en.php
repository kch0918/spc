...
$query2 = "select *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 from SPC_NOTICE where lang = 'en' and expo_yn='Y'";
// print_r($_POST);
...
<div class="notice-sec">
	<div class="contri-list cardtype-list">
      <form id="fncForm" name="fncForm" method="post" action="/share/spc-foundation/notice/?lang=en">
        	...
        	<div class="board-search">
        		<div class="search-input">
                	<input type="text" id="search_name" name="search_name" placeholder="Subject + Content"  value="<?php echo $_POST['search_name']?>">
<!--                 	<button type="submit" class="ico_search">검색</button> -->
				...
				<li>
					<a href="javascript:goNotice(<?php echo $row2['idx']?>);">
						...
						<div class="cont">
							...
							<div class="etc">
								<span class="writer">Notices</span><time class="date"><?php echo $row2['submit_date2']?></time>
							</div>
						</div>
					</a>
				</li>
		...
		<div class="page_box">
			<div class="board-pagination">
				    <a href="" class="prev-btn prev_"  onclick="pageMove(<?=$s_page-1?>)">Previous</a>
                    <?php 
                    $pagingCnt = 0;
                    if($e_page != 0)
                    {
