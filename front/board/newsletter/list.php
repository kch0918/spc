...
$query2 = "select *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 from SPC_NEWS where lang = 'ko' and expo_yn='Y'";
// print_r($_POST);
...
<div class="contri-wr text-center">
	<div class="contri-sec contri-sec05">
		<h2 class="ft-42 bold color-000 global-tit img-ani bottom-top">뉴스레터</h2>
			...
			<div class="slide-wr">
				<div class="magazine-latest swiper-container">
					<ul class="tranDelayList swiper-wrapper">
					    <?php 
                        $query = "select *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 from SPC_NEWS where expo_yn = 'Y' and lang = 'ko' order by submit_date DESC LIMIT 5";
