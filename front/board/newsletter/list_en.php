...
$query2 = "select *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 from SPC_NEWS where lang = 'en' and expo_yn='Y'";
// print_r($_POST);
...
<div class="contri-wr text-center">
	...
	<div class="contri-sec contri-sec05">
		...
		<form id="fncForm" name="fncForm" method="post" action="/csr/society/newsletter/?lang=en">
			...
			<div class="slide-wr">
				<div class="magazine-latest swiper-container">
					<ul class="tranDelayList swiper-wrapper">
					    <?php 
                        $query = "select *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 from SPC_NEWS where expo_yn = 'Y' and lang = 'en' order by submit_date DESC LIMIT 5";
