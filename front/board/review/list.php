...
$query2 = "select *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 from SPC_REVIEW where expo_yn='Y' and lang ='ko'";
// print_r($_POST);
	...
	if(validationFlag == "Y")
	{
		$("#fncForm2").ajaxSubmit({
			success: function(data)
			{
	    		...
	    		{
	    			alert("저장되었습니다.");
	    			location.href="/share/society/review/";
	    		}
	    		else
	    		{
	    			alert(result.msg);
...
<div class="contri-wr text-center">
	<div class="contri-sec contri-sec01">
		<h2 class="ft-42 bold color-000 global-tit img-ani bottom-top">ESG 인기 참여후기</h2>
		 <form id="fncForm" name="fncForm" method="post" action="/share/society/review/">
			...
			<div class="contri-list cardtype-list slide-wr">
				<div class="swiper-container">
					<ul class="swiper-wrapper tranDelayList">
					   <?php 
                        $query = "select *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 from SPC_REVIEW where top_review = 'Y' and lang='ko' order by submit_date DESC LIMIT 5";
						...
						<li class="swiper-slide">
							<a href="javascript:goDetail(<?php echo $row['idx']?>);">
								...
								<div class="cont">
									...
									<div class="etc">
										<span class="writer">참여후기</span><time class="date"><?php echo $row['submit_date2']?></time>
									</div>
								</div>
							</a>
						</li>
	...
	<div class="contri-sec contri-sec04">
		<h2 class="ft-42 bold color-000 global-tit img-ani bottom-top">ESG 참여후기 전체보기
			<div class="review-btnwr"><a class="maga-btn review-btn"><img src="/img/csr/write-btn.png" alt="참여후기 작성하기">참여후기 작성하기</a></div>
		</h2>
				...
				<li>
					<a href="javascript:goDetail(<?php echo $row2['idx']?>);">
						...
						<div class="cont">
							...
							<div class="etc">
								<span class="writer">참여후기</span><time class="date"><?php echo $row2['submit_date2']?></time>
							</div>
						</div>
					</a>
				</li>
				...
				<div class="table">
					<div>
						<div class="pop-h2">
							...
							<h2>사회공헌 참여후기 제출하기</h2>
						</div>
						<form id="fncForm2" method="post" action="/front/board/review/list_proc.php" enctype="multipart/form-data" onSubmit="return false;">
						<div class="pop-cont">
							<div class="scrollbar-inner">
								<div class="pop-form">
									<div class="table">
										<div class="pop-th">작성자</div>
										<div class="pop-td"><input type="text" name="reg_name" class="notempty" data-name="작성자" placeholder=""></div>
									</div>
									<div class="table">
										<div class="pop-th">이메일</div>
										<div class="pop-td">
											<div class="email-row table">
												<div>
													<div class="table ">
														<div><input type="text" placeholder="이메일 입력" name="email1" class="notempty" data-name="이메일"></div>
														<div class="data-hi">@</div>
									...
									<div class="table">
										<div class="pop-th">소속</div>
										<div class="pop-td">											
											<div class="table contri-data">
												<div><input type="text" name="corp" placeholder="회사명" class="notempty" data-name="회사명"></div>
												<div><input type="text" name="corp_dep" placeholder="부서명" class="notempty" data-name="부서명"></div>
											</div>
										</div>
									</div>
									<div class="table">
										<div class="pop-th">참석자</div>
										<div class="pop-td"><input type="text" placeholder="ex)홍길동" name="attend" class="notempty" data-name="참석자"></div>
									</div>
									<div class="table">
										<div class="pop-th">참석일시</div>
										<div class="pop-td">
											<div class="contri-data">
												<div class="table">
									...
									<div class="table">
										<div class="pop-th">활동장소</div>
										<div class="pop-td"><input type="text" placeholder="" name="place" class="notempty" data-name="활동장소"></div>
									</div>
									<div class="table">
										<div class="pop-th">제목</div>
										<div class="pop-td"><input type="text" placeholder="제목을 입력 하세요." name="title" class="notempty" data-name="제목"></div>
									</div>
									<div class="table">
										<div class="pop-th">내용</div>
										<div class="pop-td">
										<div class="edit-text">
										<textarea id="contents" name="contents" class="notempty" data-name="내용"></textarea></div></div>
									</div>
									<div class="table">
                            			<div class="pop-th"><label for="uploadThumb">썸네일</label></div>
                            			<div class="pop-td">
                            				<div class="form-file">
                            					<input type="text" class="input-narrow notempty" id="fakeThumbName" placholder="파일 선택" data-name="썸네일">
                            					<span class="file-btn">
					...
					<div class="btn-wr">
						<a href="http://spcweb.musign.co.kr/csr/society/review/" class="btn btn01">취소하기</a>
						<a href="javascript:fncSubmit2();" class= "btn btn02" >등록하기</a>
					</div>
					</form>
				</div>
			</div>
