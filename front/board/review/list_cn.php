...
<?php 
	...
	<div class="contri-sec contri-sec01">
		<h2 class="ft-42 bold color-000 global-tit img-ani bottom-top">ESR人气参与感想</h2>
						...
						<li class="swiper-slide">
							<a href="javascript:goDetail(<?php echo $row['idx']?>);">
								...
								<div class="cont">
									...
									<div class="etc">
										<span class="writer">参与感想</span><time class="date"><?php echo $row['submit_date2']?></time>
									</div>
								</div>
							</a>
						</li>
	...
	<div class="contri-sec contri-sec04">
		<h2 class="ft-42 bold color-000 global-tit img-ani bottom-top">查看所有ESG参与感想
			<div class="review-btnwr"><a class="maga-btn review-btn"><img src="/img/csr/write-btn.png" alt="编辑参与感想">编辑参与感想</a></div>
		</h2>
				...
				<li>
					<a href="javascript:goDetail(<?php echo $row2['idx']?>);">
						...
						<div class="cont">
							...
							<div class="etc">
								<span class="writer">参与感想</span><time class="date"><?php echo $row2['submit_date2']?></time>
							</div>
						</div>
					</a>
				</li>
					...
					<div>
						...
						<div class="pop-cont">
							<div class="scrollbar-inner">
								<div class="pop-form">
									<div class="table">
										<div class="pop-th">作者</div>
										<div class="pop-td"><input type="text" name="reg_name" class="notempty" data-name="작성자" placeholder=""></div>
									</div>
									<div class="table">
										<div class="pop-th">电子邮件</div>
										<div class="pop-td">
											<div class="email-row table">
												<div>
													<div class="table ">
														<div><input type="text" placeholder="电子邮件" name="email1" class="notempty" data-name="이메일"></div>
														<div class="data-hi">@</div>
														<div><input type="text" id="email-list" placeholder="选择直接输入时" name="email2" class="notempty" data-name="이메일"></div>
													</div>
												</div>
												<div>
													<div class="select">
									...
									<div class="table">
										<div class="pop-th">所属</div>
										<div class="pop-td">											
											<div class="table contri-data">
												<div><input type="text" name="corp" placeholder="公司名称" class="notempty" data-name="회사명"></div>
												<div><input type="text" name="corp_dep" placeholder="部门名称" class="notempty" data-name="부서명"></div>
											</div>
										</div>
									</div>
									<div class="table">
										<div class="pop-th">参加者</div>
										<div class="pop-td"><input type="text" placeholder="例)" name="attend" class="notempty" data-name="참석자"></div>
									</div>
									<div class="table">
										<div class="pop-th">参与时间</div>
										<div class="pop-td">
											<div class="contri-data">
												<div class="table">
									...
									<div class="table">
										<div class="pop-th">活动场所</div>
										<div class="pop-td"><input type="text" placeholder="" name="place" class="notempty" data-name="활동장소"></div>
									</div>
									<div class="table">
										<div class="pop-th">题目</div>
										<div class="pop-td"><input type="text" placeholder="请输入题目或内容" name="title" class="notempty" data-name="제목"></div>
									</div>
									<div class="table">
										<div class="pop-th">参加者</div>
										<div class="pop-td">
									...
									<div class="table">
                            			...
                            			<div class="pop-td">
                            				<div class="form-file">
                            					<input type="text" class="input-narrow notempty" id="fakeThumbName" placholder="选择文件" data-name="썸네일">
                            					<span class="file-btn">
								...
								<div class="btn-wr">
									<a href="http://spcweb.musign.co.kr/csr/society/review/?lang=en" class="btn btn01">取消</a>
									<a href="javascript:fncSubmit2();" class= "btn btn02" >上传</a>
								</div>
							</div>
						</div>
					</div>
