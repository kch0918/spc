...
$query2 = "select *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 from SPC_REPORT where expo_yn='Y' and lang='cn'";
// print_r($_POST);
...
<div class="contri-wr text-center">
	<div class="contri-sec contri-sec01">
		...
		<form id="fncForm" name="fncForm" method="post" action="/media-hub/news/?lang=zh-hans">
			...
			<div class="contri-list cardtype-list cardtype-list02 slide-wr">
				<div class="swiper-container">
					<ul class="swiper-wrapper tranDelayList">
						<?php 
                        $query = "select *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 from SPC_REPORT where expo_yn = 'Y' and lang = 'cn' order by submit_date DESC LIMIT 5 ";
