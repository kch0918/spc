...
function goNews(idx)
{
	location.href="/media-hub/news/detail/?idx="+idx + "&lang=zh-hans";
}
</script>
<div class="news-latest cardtype-list slide-type01">
	...
	<ul class="swiper-wrapper tranDelayList">
	 <?php 
            $query = "select *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 from SPC_REPORT where lang = 'cn' order by submit_date DESC limit 4";
