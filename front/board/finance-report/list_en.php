...
$query2 = "select *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 from SPC_FINANCE where lang = 'en' and expo_yn='Y'";
// print_r($_POST);
...
<div class="board-default-wrap">
    <form id="fncForm" name="fncForm" method="post" action="/share/spc-foundation/finance-report-list/?lang=en">
