...
$query2 = "select *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 from SPC_FINANCE where lang = 'cn' and expo_yn='Y'";
// print_r($_POST);
...
<div class="board-default-wrap">
    <form id="fncForm" name="fncForm" method="post" action="/share/spc-foundation/finance-report-list/?lang=zh-hans">
    	...
    	<div class="board-search">
    		<div class="search-input">
		    	<input type="text" id="search_name" name="search_name" placeholder="题目+内容"  value="<?php echo $_POST['search_name']?>">
