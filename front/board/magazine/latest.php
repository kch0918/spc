...
function goDetail()
{
	location.href="/media-hub/magazine";
}
</script>
<div class="magazine-latest">
	<ul class="tranDelayList">
    <?php 
            $query = "select *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 from SPC_MAGAZINE where language = '국문' order by submit_date DESC limit 4";
