...
<div class="contri-wr text-center">
	<div class="contri-sec contri-sec02">
		<h2 class="ft-42 bold color-000 global-tit letter-0 img-ani bottom-top">SPC그룹 공식 SNS채널</h2>
		<div class="btnwr img-ani bottom-top">
			<a href="https://www.instagram.com/spc_group/" target="_blank" class="main-btn sns-btn sns-btn01">
				<img src="/img/insta-i02.png" alt="spc.happyphoto 바로가기">인스타그램
			</a>
		</div>
		...
		<div class="btnwr img-ani bottom-top">
			<a href="https://www.facebook.com/happySPC" target="_blank" class="main-btn sns-btn sns-btn02">
				<img src="/img/facebook-i01.png" alt="spc.happyphoto 바로가기">페이스북
			</a>
		</div>
		<div class="contri-box img-ani review-slide facebook-slide">
			<div class="contri-list cardtype-list slide-wr face-list">
				<div class="swiper-container">
					...
					<?php 
                        $query = "select *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 from SPC_SNS where expo_yn = 'Y' order by submit_date desc limit 12";
...
<!-- 								</div> -->
	...
	<div class="contri-sec sns-sec01 text-center">
		<h2 class="ft-42 bold color-000 global-tit img-ani bottom-top">브랜드 공식 채널</h2>
		<p class="ft-20 color-7d img-ani bottom-top">각 브랜드들의 공식채널을 한눈에 확인해보세요</p>
		<div class="channel-list">
		<?php 
		$query = "SELECT distinct a.idx, a.cate_logo, a.cate_name,a.sort,b.face_url, b.insta_url,b.home_url, b.youtube_url from SPC_MID_CATE a join SPC_BRAND_BOARD b on a.idx = b.parentidx ORDER BY b.sort2*1 asc";
		$result = sql_query($query);
		for($i = 0; $i < sql_count($result); $i++){
		    $row = sql_fetch($result);
		?>
		...
		<div class="channel-row">
			<div class="table">
				...
				<div class="channel-tit"><?php echo $row['cate_name']?></div>
				<?php 
