...
<div class="contri-sec sns-sec01 text-center">
	<h2 class="ft-42 bold color-000 global-tit img-ani bottom-top">브랜드 공식채널</h2>
	<p class="ft-20 color-7d img-ani bottom-top">각 브랜드들의 공식 채널을 한눈에 확인해 보세요</p>
	<div class="channel-list">
		<?php 
		$query = "SELECT distinct a.idx, a.cate_logo, a.cate_name,a.sort,b.face_url, b.insta_url, b.youtube_url, b.home_url from SPC_MID_CATE a join SPC_BRAND_BOARD b on a.idx = b.parentidx ORDER BY b.sort2*1 asc";
...
<div class="contri-sec sns-sec01 text-center">
	<h2 class="ft-42 bold color-000 global-tit img-ani bottom-top">계열사 홈페이지 바로가기</h2>
	<div class="channel-list">
	<?php 
	$query = "SELECT distinct a.idx,a.cate_logo,a.cate_name,a.sort,b.home_url from SPC_MID_CATE a join SPC_SUB_BOARD b on a.idx = b.parentidx order by b.idx asc";
	$result = sql_query($query);
	for($i = 0; $i < sql_count($result); $i++){
	    $row = sql_fetch($result);
	    ?>
