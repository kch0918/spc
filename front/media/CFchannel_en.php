...
$query = "select *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 from SPC_CF where lang = 'en' and expo_yn='Y'";
				...
				<div class="table">
					<div>
						<div class="select" id="search_option2" name="search_option2">
							<p id="type_name2"><strong>Division</strong></p>
								<ul id="Cate2">
									<li><a href="javascript:Cate2();">All</a></li>
									<li><a href="javascript:Cate2('삼립');">Samlip</a></li>
									<li><a href="javascript:Cate2('파리바게뜨');">Paris Baguette</a></li>
									<li><a href="javascript:Cate2('배스킨라빈스');">Baskin Robbins</a></li>
									<li><a href="javascript:Cate2('던킨');">Dunkin' Donuts</a></li>
								</ul>
						</div>
					</div>
					<div class="cf-search">
