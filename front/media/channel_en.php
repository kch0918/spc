...
<div class="contri-sec sns-sec01 text-center">
	<h2 class="ft-42 bold color-000 global-tit img-ani bottom-top">Brand's official channel</h2>
	<p class="ft-20 color-7d img-ani bottom-top">Check the official channels of our brands at a glance</p>
...
<div class="contri-sec sns-sec01 text-center">
	<h2 class="ft-42 bold color-000 global-tit img-ani bottom-top">Go to affiliates' websites</h2>
	<div class="channel-list">
<?php 
