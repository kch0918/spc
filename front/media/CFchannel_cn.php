...
$query = "select *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 from SPC_CF where lang = 'cn' and expo_yn='Y'";
				...
				<div class="table">
					<div>
						<div class="select" id="search_option2" name="search_option2">
							<p id="type_name2"><strong>区分开</strong></p>
								<ul id="Cate2">
									<li><a href="javascript:Cate2();">整个儿</a></li>
									<li><a href="javascript:Cate2('삼립');">三立</a></li>
									<li><a href="javascript:Cate2('파리바게뜨');">巴黎贝甜</a></li>
									<li><a href="javascript:Cate2('배스킨라빈스');">芭斯罗缤</a></li>
									<li><a href="javascript:Cate2('던킨');">唐恩都乐</a></li>
								</ul>
						</div>
					</div>
					<div class="cf-search">
