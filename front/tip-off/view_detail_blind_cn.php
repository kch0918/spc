...
$query  = "SELECT * ,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 from SPC_NAGATION where id = '{$_SESSION['user_id']}' and idx = '{$board_idx}'";
...
function insReply_blind() {
	...
	$.ajax({
		type: "get",
		url: "/front/tip-off/insReply_blind.php",
		dataType:"text",
		async: false,
		data:{
			idx : idx,
...
<div class="tip-off-view">
	...
	<div class="tip-off-reply">
    	...
    	<div class="reply_write">
    		<div class="reply_view_box table">
    			<div class="write_cont_tit reply_writer"><?php echo $_SESSION['user_id']?></div>
				<div class="write_area"><textarea id="reply" name="reply" placeholder="댓글 내용 작성"></textarea></div>
				<div class="reply_info"><a href="javascript:insReply_blind();" class="reply_save">댓글달기</a></div>					
        	</div>
        </div>  
    	<!--// 댓글 쓰기  -->
    </div>  
    <div class="btn-wrap">
	    <a href="/csr/right-mng/view-list-blind/?lang=zh-hans" class="btn btn02">目录</a>
    </div>
</div>  
