...
if ($_SESSION['user_idx'] == "") {
    ...
    echo "<meta http-equiv='refresh' content='0;url=/csr/right-mng/tip-off-login/'>";
    
    exit;
}

$query  = "SELECT *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 from SPC_NAGATION where name = '{$_SESSION['user_name']}' and id = '{$_SESSION['user_id']}'";
...
function goDetail(idx) {
	location.href="/csr/right-mng/view-detail/?idx="+idx;
}
</script>
...
<div class="report-list">
    ...
    <div class="page_box">
        <div class="board-pagination">
        		<a href="" class="prev_ prev-btn"  onclick="pageMove(<?=$s_page-1?>)">이전</a>
                <?php 
                $pagingCnt = 0;
                if($e_page != 0)
                {
