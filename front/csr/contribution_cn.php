...
$query2 = "select *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 from SPC_SOCIAL where lang = 'cn' and expo_yn='Y'";
// print_r($_POST);
...
{
	location.href="/contributionView?seq="+seq + "&lang=zh-hans";
}
...
<?php 
	...
	<div class="contri-sec contri-sec01">
		<h2 class="ft-42 bold color-000 global-tit img-ani bottom-top">社会贡献消息</h2>
		<p class="ft-20 color-7d img-ani bottom-top">请您观看SPC集团温暖的社会贡献新闻</p>
		<form id="fncForm" name="fncForm" method="post" action="/share/society/contribution/?lang=zh-hans">
			...
			<div class="contri-list cardtype-list">
				<div class="swiper-container">
					<ul class="swiper-wrapper tranDelayList">
					 <?php 
                        $query = "select *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 from SPC_SOCIAL where expo_yn='Y' and lang = 'cn' order by submit_date DESC LIMIT 5";
	...
	<div class="contri-sec contri-sec02">
		<h2 class="ft-42 bold color-000 global-tit img-ani bottom-top">SPC幸福财团的Instagram</h2>
...
<!-- 								</div> -->
	...
	<div class="contri-sec contri-sec03">
		<h2 class="ft-42 bold color-000 global-tit img-ani bottom-top">观看社会贡献新闻视频</h2>
