...
$query2 = "select *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 from SPC_SOCIAL where lang = 'en' and expo_yn='Y'";
// print_r($_POST);
...
{
	location.href="/contributionView?seq="+seq + "&lang=en";
}
...
<div class="contri-wr text-center">
	...
	<div class="contri-sec contri-sec01">
		<h2 class="ft-42 bold color-000 global-tit img-ani bottom-top">Latest News in ESG</h2>
		<p class="ft-20 color-7d img-ani bottom-top">Meet SPC Group's warm social contribution news</p>
		<form id="fncForm" name="fncForm" method="post" action="/share/society/contribution/?lang=en">
			...
			<div class="contri-list cardtype-list">
				<div class="swiper-container">
					<ul class="swiper-wrapper tranDelayList">
					 <?php 
                        $query = "select *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 from SPC_SOCIAL where expo_yn='Y' and lang = 'en' order by submit_date DESC LIMIT 5";
						...
						<li class="swiper-slide">
                			...
                			?>
								...
								<div class="cont">
									...
									<!-- <p class="desc ft-16"><?php echo $row['contents']?></p> -->
									<div class="etc">
	...
	<div class="contri-sec contri-sec02">
		<h2 class="ft-42 bold color-000 global-tit img-ani bottom-top">SPC Happy Foundation Instagram</h2>
...
<!-- 								</div> -->
	...
	<div class="contri-sec contri-sec03">
		<h2 class="ft-42 bold color-000 global-tit img-ani bottom-top">Watch the social contribution news video</h2>
		<div class="contri-box">
			...
			<div class="btnwr img-ani bottom-top">
				<a href="https://www.youtube.com/channel/UCiyg3rAdPOJN4eKAgAs5FOQ" target="_blank" class="main-btn home-href">
					<img src="/img/youtube-i01.png" alt="YOUTUBE 바로가기">Go to Youtube
				</a>
			</div>
		</div><!-- //contri-box -->
	</div>
	<div class="contri-sec contri-sec04">
		<h2 class="ft-42 bold color-000 global-tit img-ani bottom-top">ESG News</h2>
		<p class="ft-20 color-7d img-ani bottom-top">Meet SPC Group's warm social contribution news</p>
		<div class="contri-box img-ani">
