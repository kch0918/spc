...
<div id="container" class="brand write bt-add">
			...
			<div class="search_top write_search">
				...
				<div class="def">
					...
					<select id="sub_type" name="sub_type">
						<option><?php echo $row['cate_brand_kr']?></option>
    					<?php
	...
	<div class="write_cont_box">
		<form id="fncForm" name="fncForm" method="post" action="branch_edit_proc.php" enctype="multipart/form-data" onSubmit="return false;">
...
<!-- 				<div class="write_li_tit "> 
					...
					<input type="text" id="" name="title" class="tit_area notempty" placeholder="여기에 제목을 입력하세요" data-name="제목" value='<?php echo $row['title']?>'>
 				</div> -->
				...
				<div class="write_li_file">
					...
					<input type="text" id="tel" name="tel" class="file_area" data-name="연락처"  placeholder="텍스트 입력" value='<?php echo $row['tel']?>'>
				</div>
				<div class="write_li_file">
				<?php 
