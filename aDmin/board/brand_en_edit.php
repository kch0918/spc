	...
	if(validationFlag == "Y")
	{
		$("#fncForm").ajaxSubmit({
			...
			success: function(data)
			{
	    		...
	    		{
	    			alert("저장되었습니다.");
	    			location.href="/aDmin/board/brand_en.php";
	    		}
	    		else
	    		{
	    			alert(result.msg);
...
<div id="container" class="brand write bt-add">
	...
	<div class="write_cont_box">
		<form id="fncForm" name="fncForm" method="POST" action="brand_en_edit_proc.php" onSubmit="return false;" enctype="multipart/form-data">
		...
		<div class="write_bt">
			<ul>
				<li><a href="/aDmin/board/brand_en.php" class="bt_cont">목록</a></li>
