...
{
	location.href="/aDmin/board/brand_en_edit.php?idx="+idx;
}
...
function changeFunc() {
 ...
 location.href = "/aDmin/board/brand_en.php?order_by="+selectedValue;
...
<div id="container" class="report">	
	<div class="search">
		<p>브랜드 관리(영문)<strong>생성된 게시글을 관리합니다.</strong></p>
	</div>
