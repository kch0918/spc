	...
	if(validationFlag == "Y")
	{
		$("#fncForm").ajaxSubmit({
			...
			success: function(data)
			{
	    		...
	    		{
	    			alert("저장되었습니다.");
	    			location.href="/aDmin/board/branch_cn.php";
	    		}
	    		else
	    		{
	    			alert(result.msg);
...
<div id="container" class="brand write bt-add">
	...
	<div class="write_cont_box">
		<form id="fncForm" name="fncForm" method="post" action="branch_cn_edit_proc.php" enctype="multipart/form-data" onSubmit="return false;">
...
<!-- 				<div class="write_li_tit "> 
		...
		<div class="write_bt">
			<ul>
				<li><a href="/aDmin/board/branch_cn.php" class="bt_cont">목록</a></li>
