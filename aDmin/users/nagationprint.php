...
//	printArea.innerHTML = opener.document.getElementById("printContents").innerHTML;
	window.print();
...
<div id="container" class="review nagation write">
	...
	<form id="fncForm" method="post" action="nagation_detail_proc.php" onSubmit="return false;">
	<input type="hidden" name="idx" value="<?php echo $row["idx"]?>">
	<div class="write_cont_box bg_gray">
		<div class="write_cont">
			<div>
				<div class="write_li_add">
					<p class="write_cont_tit">접수일자</p>
                    ...
                    <p class="write_cont_tit tit_margin">유선 상담 가능여부</p>
                    <?php 
                    if($row['tel_yn'] == "Y") {
                    ?>
                    <input type="text" id="tel_yn" name="tel_yn" class="info_area" value="가능" readonly/>
                    <?php 
                    } else {
                    ?>
                    <input type="text" id="tel_yn" name="tel_yn" class="info_area" value="불가능" readonly/>
					<?php                         
                    }
                    ?>
				</div>
				<div class="write_li_file">
					...
					<input type="text" id="name" name="name" class="info_area" readonly value="<?php echo $row['name']?>">
                     <p class="write_cont_tit tit_margin">이메일</p>
                    <input type="text" id="" name="" class="info_area" readonly value="<?php echo $row['email']?>">
                    <p class="write_cont_tit tit_margin">연락처</p>
                    <input type="text" id="" name="" class="info_area" readonly value="<?php echo $row['tel']?>">
				</div>				
                <div class="write_li_file">
                    <p class="write_cont_tit">제목</p>
                    <input type="text" id="" name="" class="tit_area" readonly value="<?php echo $row['title']?>">
                </div>
                <div id="printContents" class="write_li_file">
                    <p class="write_cont_tit">제보 내용</p>
                    <textarea id="" name="" class="cont_area" readonly value=""><?php echo $row['contents']?></textarea>
                </div>
				<div class="write_check">
                    <p class="write_cont_tit">추가 질문</p>
                    <textarea id="" name="" class="cont_area" readonly value=""><?php echo $row['add_answer']?></textarea>
                </div>    
                <?php 
                if($row['file'] != null) {
                ?>	
		...
		<div class="write_cont">
			<div>
				<div class="write_li_add">
                    ...
                    <div class="date_box no_left"> 
                    <input type="text" id="start_date2" name="start_date2" class="info_area notempty" data-name="등록일" placeholder="날짜를 입력해주세요" value="<?php echo $row['submit_date3']?>"></div>
				</div>
				...
				<div class="write_li_add">
                    ...
                    <div class="reply_box">
                	          ...
                	          for ($i = 0; $i < sql_count($result2); $i++) {
                    	       ...
                    	       <input type="hidden" name="reply_idx" value="">
                            	<div class="reply_view_box line">
                            		<p class="write_cont_tit reply_writer"><input type="text" id="" name="" placeholder="" value="<?php echo $row2['name']?>"></p>
        							<div class="write_area">
        								<div><?php echo $row2['contents']?></div>
        								<div class="reply_info">
        									<input type="text" name="" placeholder="" value="<?php echo $row2['submit_date']?>">
                    	...
                    	<div class="reply_view_box reply_wirte">
                    		<p class="write_cont_tit reply_writer"><input type="text" id="" name="" placeholder="" value="<?php echo $_SESSION['name']?>"></p>
                    		<?php echo $_SESSION['name']?>
							<div class="write_area">
								<input type="textarea" name="reply" placeholder="관리자 답변">
