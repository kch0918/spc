...
$query = "SELECT *,DATE_FORMAT(submit_date, '%Y-%m-%d') as submit_date2 FROM SPC_CF where 1";
...
function changeFunc() {
	 ...
	 location.href = "/aDmin/media/cf.php?order_by="+selectedValue;
...
$(document).ready(function(){
	...
	$(".selectedOption").val(search_option);
...
function goCf(idx)
{
	location.href="/aDmin/media/cf_edit.php?idx="+idx;
}
...
function goDelete(idx)
{
	if(confirm("해당 게시물을 삭제하시겠습니까?"))
    {
	   ...
	   $.ajax({
   		type: "post",
   		url: "/aDmin/media/cf_delete_proc.php",
   		dataType:"text",
   		data : 
   		{
       		idx : idx
...
<div id="container" class="report magazine cf">
	<div class="search">
		<p>CF  컨텐츠 리스트<strong>생성된 게시글을 관리합니다.</strong></p>
		<input type="button" class="enroll" value="등록" onclick="location.href='/aDmin/media/cf_write.php'">
		<form id="fncForm" name="fncForm" method="post" action="cf.php">
		...
		<div class="seacrh_info">
			...
			<div class="search_bot">
                ...
                <div class="def-select">
                    <select id="search_option" name="search_option" class="seacrh_sel">
            					...
            					<tr>
            						...
            						<?php if($row['expo_yn'] == "Y") {
            						    ...
            						    <?php 
                						  ...
                						  ?>
            						<td><a class="edit" onclick="goCf(<?php echo $row['idx']?>)">수정</a></td>
