...
<div id="container" class="news write">
	...
	<form id="fncForm"  method="post" action="cf_write_proc.php" enctype="multipart/form-data" onSubmit="return false;">	
    			...
    			<div>
                    <div class="write_li_tit def-select">
    				 ...
    				 <div class="write_li_tit">	
                        ...
                        <div class="date_box">
                        	<input type="text" id="start_date" name="start_date" class="search_date notempty" data-name="등록일" placeholder="날짜를 입력해주세요" value="">
                        </div>	
                	</div>	
    				<div class="write_li_tit">
                    ...
                    <div class="write_li_file">
                        ...
                        <input type="text" name="url" class="file_area"  placeholder="URL 입력" value=''>
                    </div>
    				<div class="write_li_file">
