...
<div id="container" class="news write bt-add">
	<div class="search">
		<p>재정보고 등록<strong>생성된 컨텐츠를 수정하고 관리합니다.</strong></p>		
	</div>
	<form id="fncForm"  method="post" action="finance_write_proc.php" enctype="multipart/form-data" onSubmit="return false;">	
