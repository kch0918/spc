...
$query = "SELECT *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 FROM SPC_FINANCE where 1";
...
function changeFunc() {
	 ...
	 location.href = "/aDmin/csr/finance.php?order_by="+selectedValue;
...
{
	location.href="/aDmin/csr/finance_edit.php?idx="+idx;
}
...
function goDelete(idx)
{
	if(confirm("해당 게시물을 삭제하시겠습니까?"))
    {
	   ...
	   $.ajax({
   		type: "post",
   		url: "/aDmin/csr/finance_delete_proc.php",
   		dataType:"text",
   		data : 
   		{
       		idx : idx
...
<div id="container" class="report magazine">
	<div class="search">
		<p>재정보고<strong>생성된 게시글을 관리합니다.</strong></p>
		<input type="button" class="enroll" value="등록" onclick="location.href='/aDmin/csr/finance_write.php'">
		<form id="fncForm" name="fncForm" method="post" action="finance.php">
            					...
            					<tr>
            						...
            						<?php if($row['expo_yn'] == "Y") {
            						    ...
            						    <?php 
                						  ...
                						  ?>
            						<td><a class="edit" onclick="goFinance(<?php echo $row['idx']?>)">수정</a></td>
