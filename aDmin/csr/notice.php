...
$query = "SELECT *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 FROM SPC_NOTICE where 1";
...
function changeFunc() {
	 ...
	 location.href = "/aDmin/csr/notice.php?order_by="+selectedValue;
...
{
	location.href="/aDmin/csr/notice_edit.php?idx="+idx;
}
...
function goDelete(idx)
{
	if(confirm("해당 게시물을 삭제하시겠습니까?"))
    {
	   ...
	   $.ajax({
   		type: "post",
   		url: "/aDmin/csr/notice_delete_proc.php",
   		dataType:"text",
   		data : 
   		{
       		idx : idx
...
<div id="container" class="report magazine">
	<div class="search">
		<p>공지사항<strong>생성된 게시글을 관리합니다.</strong></p>
		<input type="button" class="enroll" value="등록" onclick="location.href='/aDmin/csr/notice_write.php'">
            					...
            					<tr>
            						...
            						<?php if($row['expo_yn'] == "Y") {
            						    ...
            						    <?php 
                						  ...
                						  ?>
            						<td><a class="edit" onclick="goNotice(<?php echo $row['idx']?>)">수정</a></td>
