	...
	if(validationFlag == "Y")
	{
		$("#fncForm").ajaxSubmit({
			...
			success: function(data)
			{
	    		...
	    		{
	    			alert("저장되었습니다.");
	    			location.href="/aDmin/csr/news.php";
	    		}
	    		else
	    		{
	    			alert(result.msg);
...
<div id="container" class="news write bt-add">
	<div class="search">
		<p>뉴스레터 수정<strong>생성된 컨텐츠를 수정하고 관리합니다.</strong></p>		
	</div>
	<form id="fncForm"  method="post" action="news_edit_proc.php" enctype="multipart/form-data" onSubmit="return false;">	
	...
	<input type="hidden" name="prev_file" value="<?php echo $row["file"]?>">
    		...
    		<div class="write_cont">
    			<div>
    				...
    				<div class="write_li_file">
    					...
    					<span class="upload-name file_area thumb" placeholer="500MB 이내로 업로드 "><?php echo $row['thumb']?></span>
		...
		<div class="write_bt">
			<ul>
				<li><a href="/aDmin/csr/news.php" class="bt_cont">목록</a></li>
