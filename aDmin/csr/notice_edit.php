...
<div id="container" class="news write bt-add">
	<div class="search">
		<p>공지사항 수정<strong>생성된 컨텐츠를 수정하고 관리합니다.</strong></p>		
	</div>
	<form id="fncForm"  method="post" action="notice_edit_proc.php" enctype="multipart/form-data" onSubmit="return false;">	
	...
	<input type="hidden" name="prev_file" value="<?php echo $row["file"]?>">
		...
		<div class="write_bt">
			<ul>
				<li><a href="/aDmin/csr/notice.php" class="bt_cont">목록</a></li>
