...
$query = "select *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 from SPC_SOCIAL where seq = {$_REQUEST['seq']}";
...
<div id="container" class="news write bt-add">
	<div class="search">
		<p>사회공헌 수정<strong>생성된 컨텐츠를 수정하고 관리합니다.</strong></p>		
	</div>
	<form id="fncForm"  method="post" action="social_edit_proc.php" enctype="multipart/form-data" onSubmit="return false;">	
