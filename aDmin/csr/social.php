...
$query = "SELECT *,DATE_FORMAT(submit_date, '%Y.%m.%d') as submit_date2 FROM SPC_SOCIAL where 1";
...
function changeFunc() {
	 ...
	 location.href = "/aDmin/csr/social.php?order_by="+selectedValue;
...
{
	location.href="/aDmin/csr/social_edit.php?seq="+seq;
}
...
function goDelete(seq)
{
	if(confirm("해당 게시물을 삭제하시겠습니까?"))
    {
	   ...
	   $.ajax({
   		type: "post",
   		url: "/aDmin/csr/social_delete_proc.php",
   		dataType:"text",
   		data : 
   		{
       		seq : seq
...
<div id="container" class="report magazine">
	<div class="search">
		<p>사회공헌 소식<strong>생성된 게시글을 관리합니다.</strong></p>
		<input type="button" class="enroll" value="등록" onclick="location.href='/aDmin/csr/social_write.php'">
		<form id="fncForm" name="fncForm" method="post" action="social.php">
            					...
            					<tr>
            						...
            						<?php if($row['expo_yn'] == "Y") {
            						    ...
            						    <?php 
                						  ...
                						  ?>
            						<td><a class="edit" onclick="goSocial(<?php echo $row['seq']?>)">수정</a></td>
