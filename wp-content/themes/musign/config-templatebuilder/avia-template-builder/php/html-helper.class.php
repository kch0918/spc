...
if ( ! class_exists( 'AviaHtmlHelper' ) ) 
{
	...
	class AviaHtmlHelper 
	{
		...
		*/
		 ...
		 * @return string
		 */
		static public function input_number( $element )
		{
			...
			$output = '<input type="number" class="' . $element['class'] . '" value="' . nl2br( $element['std'] ) . '" id="' . $element['id'] . '" name="' . $element['id'] . '" ' . $min . $max . $placeholder . $readonly . $step . '/>';
